...
export PATH="$HOME/.rbenv/shims:/usr/local/bin:$HOME/.rbenv/shims:$HOME/.rbenv/shims:/usr/local/bin:$HOME/.rbenv/shims:/usr/local/opt/pyenv/shims:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin"
